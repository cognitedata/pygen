...
# TODO: 230925 pa: patching `DomainModelApply`
from ._core_patch import DomainModelApplyPatch
...
# patching causing this Warning
# UserWarning: Field name "external_id" shadows an attribute in parent "DomainModelApply"
warnings.filterwarnings(
    "ignore",
    category=UserWarning,
    message='Field name "external_id" shadows an attribute',
)


# TODO: 230925 pa: inject support for `model_config` and `external_id` into `DomainModelApply`
class DomainModelApply(DomainModelApplyPatch, DomainModelCore):
