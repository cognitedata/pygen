...
class Implementation1API(NodeAPI[Implementation1, Implementation1Write, Implementation1List, Implementation1WriteList]):
    ...
    ) -> Iterator[Implementation1List]:
        """Iterate over implementation 1

        Args:
            chunk_size: The number of implementation 1 to return in each iteration. Defaults to 100.
            main_value: The main value to filter on.
            main_value_prefix: The prefix of the main value to filter on.
            sub_value: The sub value to filter on.
            sub_value_prefix: The prefix of the sub value to filter on.
            ...
            filter: (Advanced) If the filtering available in the above is not sufficient,
                you can write your own filtering which will be ANDed with the filter above.
            limit: Maximum number of implementation 1 to return. Defaults to None, which will return all items.
            cursors: (Advanced) Cursor to use for pagination. This can be used to resume an iteration from a
                specific point. See example below for more details.

        Returns:
            Iteration of implementation 1

        Examples:

            Iterate implementation 1 in chunks of 100 up to 2000 items:
            ...
            Iterate implementation 1 in chunks of 100 sorted by external_id in descending order:
            ...
            Iterate implementation 1 in chunks of 100 and use cursors to resume the iteration:
