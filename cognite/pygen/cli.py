    ...
    if settings is not None:
        ...
        def generate(
            ...
            scopes: str = typer.Option(
                default=loaded_settings.scopes.default, help=loaded_settings.scopes.help
            ),
            audience: str = typer.Option(
                default=loaded_settings.audience.default, help=loaded_settings.audience.help
            ),
        ...
        def generate(
            ...
            tenant_id: Annotated[str, typer.Option(..., help=default_settings.tenant_id.help)] = None,
            token_url: Annotated[str, typer.Option(..., help=default_settings.token_url.help)] = None,
            scopes: Annotated[str, typer.Option(..., help=default_settings.scopes.help)] = None,
            audience: Annotated[str, typer.Option(..., help=default_settings.audience.help)] = None,
