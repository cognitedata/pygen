...
from cognite.pygen._generator.gen_functions import generate_sdk as generate_sdk_v2
from cognite.pygen._generator.gen_functions import generate_sdk_notebook as generate_sdk_notebook_v2
