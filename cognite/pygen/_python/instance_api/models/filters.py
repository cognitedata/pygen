...
from pydantic import BaseModel, BeforeValidator, ConfigDict, Field, JsonValue, TypeAdapter, model_serializer
from pydantic.alias_generators import to_camel
from pydantic_core.core_schema import FieldSerializationInfo

from cognite.pygen._python.instance_api.models._references import (
    ContainerReference,
    NodeReference,
    ViewReference,
)
...
class FilterDataDefinition(BaseModel, ABC):
