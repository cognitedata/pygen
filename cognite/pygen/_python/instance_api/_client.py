...
from cognite.pygen._python.instance_api.http_client import (
    FailedRequest,
    FailedResponse,
    HTTPClient,
    HTTPResult,
...
from cognite.pygen._python.instance_api.models.instance import InstanceModel, InstanceWrite
from cognite.pygen._python.instance_api.models.responses import DeleteResponse, UpsertResult
