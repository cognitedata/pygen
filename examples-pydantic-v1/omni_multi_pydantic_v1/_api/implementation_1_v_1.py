...
from omni_multi_pydantic_v1.data_classes._implementation_1_v_1 import (
...
class Implementation1v1API(NodeAPI[Implementation1v1, Implementation1v1Write, Implementation1v1List]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new implementation_1_v_1:
                ...
                >>> from omni_multi_pydantic_v1.data_classes import Implementation1v1Write
    ...
    def search(
        ...
        return self._search(
            ...
            query=query,
            properties_by_field=_IMPLEMENTATION1V1_PROPERTIES_BY_FIELD,
