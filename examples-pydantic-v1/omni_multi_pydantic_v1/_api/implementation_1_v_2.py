...
class Implementation1v2API(NodeAPI[Implementation1v2, Implementation1v2Apply, Implementation1v2List]):
    ...
    def __call__(
        ...
        return Implementation1v2QueryAPI(self._client, builder, self._view_by_read_class, filter_, limit)

    def apply(
        self, implementation_1_v_2: Implementation1v2Apply | Sequence[Implementation1v2Apply], replace: bool = False
    ) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new implementation_1_v_2:
                ...
                >>> from omni_multi_pydantic_v1.data_classes import Implementation1v2Apply
        ...
        """
        return self._apply(implementation_1_v_2, replace)
    ...
    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> Implementation1v2List:
        ...
    ...
    def search(
        ...
        return self._search(self._view_id, query, _IMPLEMENTATION1V2_PROPERTIES_BY_FIELD, properties, filter_, limit)
