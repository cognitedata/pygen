...
class SubInterfaceAPI(NodeAPI[SubInterface, SubInterfaceApply, SubInterfaceList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new sub_interface:
                ...
                >>> from omni_multi_pydantic_v1.data_classes import SubInterfaceApply
        ...
        """
        return self._apply(sub_interface, replace)
    ...
    def search(
        ...
        return self._search(self._view_id, query, _SUBINTERFACE_PROPERTIES_BY_FIELD, properties, filter_, limit)
