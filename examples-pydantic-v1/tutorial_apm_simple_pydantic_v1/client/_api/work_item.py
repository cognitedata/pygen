...
from tutorial_apm_simple_pydantic_v1.client.data_classes._work_item import (
...
class WorkItemAPI(NodeAPI[WorkItem, WorkItemApply, WorkItemList]):
    ...
    def apply(self, work_item: WorkItemApply | Sequence[WorkItemApply], replace: bool = False) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new work_item:
                ...
                >>> from tutorial_apm_simple_pydantic_v1.client.data_classes import WorkItemApply
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> WorkItem | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> WorkItemList:
        ...
