...
from markets_pydantic_v1.client.data_classes._process import _PROCESS_PROPERTIES_BY_FIELD
    ...
    def apply(self, proces: ProcessApply | Sequence[ProcessApply], replace: bool = False) -> dm.InstancesApplyResult:
        ...
        Examples:
            ...
            Create a new proces:
                ...
                >>> from markets_pydantic_v1.client.data_classes import ProcessApply
                >>> client = MarketClient()
