...
class DateTransformation(DomainModel):
    """This represent a read version of date transformation.
    ...
    def as_apply(self) -> DateTransformationApply:
        """Convert this read version of date transformation to a write version."""
...
class DateTransformationApply(DomainModelApply):
    """This represent a write version of date transformation.
...
class DateTransformationList(TypeList[DateTransformation]):
    """List of date transformations in read version."""
...
class DateTransformationApplyList(TypeApplyList[DateTransformationApply]):
    """List of date transformations in write version."""
