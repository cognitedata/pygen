...
from equipment_unit_pydantic_v1.client.data_classes._core import (
    DomainModel,
    DomainModelCore,
    DomainModelWrite,
    DomainRelationWrite,
...
from equipment_unit_pydantic_v1.client import data_classes
...
_GRAPHQL_DATA_CLASS_BY_DATA_MODEL_BY_TYPE = {
    dm.DataModelId("IntegrationTestsImmutable", "EquipmentUnit", "2"): {
        "EquipmentModule": data_classes.EquipmentModuleGraphQL,
        "StartEndTime": data_classes.StartEndTimeGraphQL,
        "UnitProcedure": data_classes.UnitProcedureGraphQL,
        "WorkOrder": data_classes.WorkOrderGraphQL,
    },
}
