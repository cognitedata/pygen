...
from equipment_unit_pydantic_v1.data_classes._equipment_module import _create_equipment_module_filter
from equipment_unit_pydantic_v1.data_classes._core import QueryStep, QueryBuilder, DomainModelList
...
def _retrieve_timeseries_external_ids_with_extra_sensor_value(
    ...
    return {
        cast(str, node.properties[view_id]["sensor_value"]): [
