...
def _retrieve_timeseries_external_ids_with_extra_bending_x(
    ...
    if extra_properties == "bending_x":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "bending_x":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "bending_x"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["bending_x"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
