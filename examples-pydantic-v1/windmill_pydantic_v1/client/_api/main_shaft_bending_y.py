...
from windmill_pydantic_v1.client.data_classes._main_shaft import _create_main_shaft_filter
...
def _retrieve_timeseries_external_ids_with_extra_bending_y(
    ...
    if extra_properties == "bending_y":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "bending_y":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "bending_y"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["bending_y"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
