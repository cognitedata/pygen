...
def _retrieve_timeseries_external_ids_with_extra_calculated_yaw_moment(
    ...
    if extra_properties == "calculated_yaw_moment":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "calculated_yaw_moment":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "calculated_yaw_moment"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["calculated_yaw_moment"]: [
