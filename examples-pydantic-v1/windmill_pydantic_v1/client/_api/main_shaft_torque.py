...
def _retrieve_timeseries_external_ids_with_extra_torque(
    ...
    properties = ["torque"]
    if extra_properties == "torque":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "torque":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "torque"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["torque"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
