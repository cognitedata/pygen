...
def _retrieve_timeseries_external_ids_with_extra_temperature(
    ...
    if extra_properties == "temperature":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "temperature":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "temperature"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["temperature"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
