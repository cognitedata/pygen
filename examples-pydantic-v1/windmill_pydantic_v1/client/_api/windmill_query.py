    ...
    def __init__(
        ...
        self._builder.append(
            QueryStep(
                ...
                select=dm.query.Select([dm.query.SourceSelector(self._view_by_write_class[WindmillApply], ["*"])]),
                result_cls=Windmill,
        ...
        self._builder.append(
            QueryStep(
                ...
                expression=dm.query.NodeResultSetExpression(
                    ...
                    from_=from_,
                    through=self._view_by_write_class[WindmillApply].as_property_ref("nacelle"),
                    direction="outwards",
                ),
