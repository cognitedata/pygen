...
def _retrieve_timeseries_external_ids_with_extra_wind_speed(
    ...
    if extra_properties == "wind_speed":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "wind_speed":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "wind_speed"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["wind_speed"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
