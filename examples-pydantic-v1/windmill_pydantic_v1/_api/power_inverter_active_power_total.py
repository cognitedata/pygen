...
def _retrieve_timeseries_external_ids_with_extra_active_power_total(
    ...
    if extra_properties == "active_power_total":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "active_power_total":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "active_power_total"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["active_power_total"]: [
