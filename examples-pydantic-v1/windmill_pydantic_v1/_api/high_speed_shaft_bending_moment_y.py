...
def _retrieve_timeseries_external_ids_with_extra_bending_moment_y(
    ...
    if extra_properties == "bending_moment_y":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "bending_moment_y":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "bending_moment_y"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["bending_moment_y"]: [
