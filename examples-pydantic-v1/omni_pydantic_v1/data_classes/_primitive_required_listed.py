...
class PrimitiveRequiredListed(DomainModel):
    ...
    Args:
        ...
        created_time: The created time of the primitive required listed node.
        last_updated_time: The last updated time of the primitive required listed node.
        deleted_time: If present, the deleted time of the primitive required listed node.
        version: The version of the primitive required listed node.
    """
...
class PrimitiveRequiredListedApply(DomainModelApply):
    ...
    Args:
        ...
        text: The text field.
        timestamp: The timestamp field.
        existing_version: Fail the ingestion request if the primitive required listed version is greater than or equal to this value.
    ...
    def _to_instances_apply(
        ...
        write_view = (view_by_write_class and view_by_write_class.get(type(self))) or dm.ViewId(
            "pygen-models", "PrimitiveRequiredListed", "1"
        )
