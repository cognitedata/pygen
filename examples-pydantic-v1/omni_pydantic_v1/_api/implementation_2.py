...
from omni_pydantic_v1.data_classes._implementation_2 import (
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new implementation_2:
                ...
                >>> from omni_pydantic_v1.data_classes import Implementation2Apply
                >>> client = OmniClient()
        ...
        """
        return self._apply(implementation_2, replace)
