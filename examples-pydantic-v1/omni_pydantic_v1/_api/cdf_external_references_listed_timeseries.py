...
from omni_pydantic_v1.data_classes._cdf_external_references_listed import _create_cdf_external_references_listed_filter
...
class CDFExternalReferencesListedTimeseriesQuery:
    def __init__(
        self,
    ...
    def retrieve(
        ...
        *,
        ...
        """`Retrieve datapoints for the `cdf_external_references_listed.timeseries` timeseries.
    ...
    def retrieve_arrays(
        ...
        *,
        ...
        """`Retrieve numpy arrays for the `cdf_external_references_listed.timeseries` timeseries.
    ...
    def retrieve_dataframe(
        ...
        *,
        ...
        """`Retrieve DataFrames for the `cdf_external_references_listed.timeseries` timeseries.
    ...
    def retrieve_dataframe_in_tz(
        ...
        *,
        ...
        """Retrieve DataFrames for the `cdf_external_references_listed.timeseries` timeseries in Timezone.
