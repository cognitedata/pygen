...
from movie_domain_pydantic_v1.client.data_classes._actor import (
...
class ActorAPI(NodeAPI[Actor, ActorApply, ActorList]):
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> Actor | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> ActorList:
        ...
