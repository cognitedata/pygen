...
from movie_domain_pydantic_v1.client.data_classes._best_leading_actor import (
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new best_leading_actor:
                ...
                >>> from movie_domain_pydantic_v1.client.data_classes import BestLeadingActorApply
                >>> client = MovieClient()
