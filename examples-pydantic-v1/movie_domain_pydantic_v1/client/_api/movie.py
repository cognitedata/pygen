...
from movie_domain_pydantic_v1.client.data_classes import Movie, MovieApply, MovieList, MovieApplyList, MovieTextFields
from movie_domain_pydantic_v1.client.data_classes._movie import _MOVIE_TEXT_PROPERTIES_BY_FIELD
