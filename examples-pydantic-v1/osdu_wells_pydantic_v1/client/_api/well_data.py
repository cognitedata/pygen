...
class WellDataAPI(NodeAPI[WellData, WellDataApply, WellDataList]):
    ...
    def apply(self, well_datum: WellDataApply | Sequence[WellDataApply], replace: bool = False) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new well_datum:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import WellDataApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> WellData | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> WellDataList:
        ...

    def retrieve(
        self, external_id: str | SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE
    ) -> WellData | WellDataList | None:
