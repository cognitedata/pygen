...
class WellDataHistoricalInterestsAPI(EdgeAPI):
    def list(
        self,
        ...
        """List historical interest edges of a well datum.
        ...
        Examples:
            ...
            List 5 historical interest edges connected to "my_well_datum":

                >>> from osdu_wells_pydantic_v1.client import OSDUClient
                >>> client = OSDUClient()
                >>> well_datum = client.well_data.historical_interests_edge.list("my_well_datum", limit=5)
