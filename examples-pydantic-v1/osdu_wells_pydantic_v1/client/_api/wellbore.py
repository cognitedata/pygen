...
from osdu_wells_pydantic_v1.client.data_classes._wellbore import (
...
class WellboreAPI(NodeAPI[Wellbore, WellboreApply, WellboreList]):
    ...
    @overload
    def retrieve(self, external_id: str) -> Wellbore | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str]) -> WellboreList:
        ...
