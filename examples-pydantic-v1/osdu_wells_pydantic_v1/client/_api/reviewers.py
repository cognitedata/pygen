...
from osdu_wells_pydantic_v1.client.data_classes._reviewers import (
...
class ReviewersAPI(NodeAPI[Reviewers, ReviewersApply, ReviewersList]):
    ...
    def apply(self, reviewer: ReviewersApply | Sequence[ReviewersApply], replace: bool = False) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new reviewer:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import ReviewersApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> Reviewers | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> ReviewersList:
        ...
