...
class WellboreTrajectoryDataAPI(
    ...
    def __call__(
        ...
        builder = QueryBuilder(WellboreTrajectoryDataList)
        return WellboreTrajectoryDataQueryAPI(self._client, builder, self._view_by_write_class, filter_, limit)
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> WellboreTrajectoryData | None:
        ...
