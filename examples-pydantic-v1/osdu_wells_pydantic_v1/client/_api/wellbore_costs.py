...
from osdu_wells_pydantic_v1.client.data_classes._wellbore_costs import (
...
class WellboreCostsAPI(NodeAPI[WellboreCosts, WellboreCostsApply, WellboreCostsList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new wellbore_cost:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import WellboreCostsApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> WellboreCosts | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> WellboreCostsList:
        ...
