...
class FacilityOperatorsAPI(NodeAPI[FacilityOperators, FacilityOperatorsApply, FacilityOperatorsList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new facility_operator:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import FacilityOperatorsApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> FacilityOperators | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> FacilityOperatorsList:
        ...
