...
class WellboreDataFacilitySpecificationsAPI(EdgeAPI):
    def list(
        self,
        ...
        """List facility specification edges of a wellbore datum.
        ...
        Examples:
            ...
            List 5 facility specification edges connected to "my_wellbore_datum":

                >>> from osdu_wells_pydantic_v1.client import OSDUClient
                >>> client = OSDUClient()
                >>> wellbore_datum = client.wellbore_data.facility_specifications_edge.list("my_wellbore_datum", limit=5)
