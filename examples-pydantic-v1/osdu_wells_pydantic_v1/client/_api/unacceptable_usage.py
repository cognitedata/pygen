...
from osdu_wells_pydantic_v1.client.data_classes._unacceptable_usage import (
...
class UnacceptableUsageAPI(NodeAPI[UnacceptableUsage, UnacceptableUsageApply, UnacceptableUsageList]):
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> UnacceptableUsage | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> UnacceptableUsageList:
        ...
