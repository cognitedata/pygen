...
class SpatialPointAPI(NodeAPI[SpatialPoint, SpatialPointApply, SpatialPointList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new spatial_point:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import SpatialPointApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> SpatialPoint | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> SpatialPointList:
        ...
