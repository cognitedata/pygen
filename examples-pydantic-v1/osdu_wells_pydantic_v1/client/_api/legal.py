...
class LegalAPI(NodeAPI[Legal, LegalApply, LegalList]):
    ...
    def __call__(
        ...
        builder = QueryBuilder(LegalList)
        return LegalQueryAPI(self._client, builder, self._view_by_write_class, filter_, limit)
    ...
    def apply(self, legal: LegalApply | Sequence[LegalApply], replace: bool = False) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new legal:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import LegalApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> Legal | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> LegalList:
        ...
