...
class FacilityStatesAPI(NodeAPI[FacilityStates, FacilityStatesApply, FacilityStatesList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new facility_state:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import FacilityStatesApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> FacilityStates | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> FacilityStatesList:
        ...
