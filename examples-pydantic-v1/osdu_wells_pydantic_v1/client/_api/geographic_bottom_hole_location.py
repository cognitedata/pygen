...
class GeographicBottomHoleLocationAPI(
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new geographic_bottom_hole_location:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import GeographicBottomHoleLocationApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> GeographicBottomHoleLocation | None:
        ...
