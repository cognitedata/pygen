...
class VerticalMeasurementAPI(NodeAPI[VerticalMeasurement, VerticalMeasurementApply, VerticalMeasurementList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new vertical_measurement:
                ...
                >>> from osdu_wells_pydantic_v1.client.data_classes import VerticalMeasurementApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> VerticalMeasurement | None:
        ...
