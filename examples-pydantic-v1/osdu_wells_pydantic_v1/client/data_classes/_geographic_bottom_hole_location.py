...
GeographicBottomHoleLocationTextFields = Literal[
    "applied_operations",
...
GeographicBottomHoleLocationFields = Literal[
    "applied_operations",
    "coordinate_quality_check_date_time",
    "coordinate_quality_check_performed_by",
    "coordinate_quality_check_remarks",
...
class GeographicBottomHoleLocation(DomainModel):
    ...
    Args:
        ...
        external_id: The external id of the geographic bottom hole location.
        ...
        created_time: The created time of the geographic bottom hole location node.
        last_updated_time: The last updated time of the geographic bottom hole location node.
        deleted_time: If present, the deleted time of the geographic bottom hole location node.
        version: The version of the geographic bottom hole location node.
    """
