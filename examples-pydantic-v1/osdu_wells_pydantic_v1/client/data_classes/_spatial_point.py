...
SpatialPointTextFields = Literal[
    "applied_operations",
...
class SpatialPoint(DomainModel):
    """This represents the reading version of spatial point.

    It is used to when data is retrieved from CDF.

    Args:
        space: The space where the node is located.
        external_id: The external id of the spatial point.
        ...
        created_time: The created time of the spatial point node.
        last_updated_time: The last updated time of the spatial point node.
        deleted_time: If present, the deleted time of the spatial point node.
        version: The version of the spatial point node.
    """
    ...
    def as_apply(self) -> SpatialPointApply:
        """Convert this read version of spatial point to the writing version."""
        return SpatialPointApply(
            space=self.space,
...
class SpatialPointApply(DomainModelApply):
    """This represents the writing version of spatial point.
    ...
    Args:
        ...
        spatial_parameter_type_id: The spatial parameter type id field.
        wgs_84_coordinates: The wgs 84 coordinate field.
        existing_version: Fail the ingestion request if the spatial point version is greater than or equal to this value.
    ...
    def _to_instances_apply(
        ...
        write_view = (view_by_write_class and view_by_write_class.get(type(self))) or dm.ViewId(
            "IntegrationTestsImmutable", "SpatialPoint", "7af8800660eef4"
        )
...
class SpatialPointList(DomainModelList[SpatialPoint]):
    """List of spatial points in the read version."""

    _INSTANCE = SpatialPoint

    def as_apply(self) -> SpatialPointApplyList:
        """Convert these read versions of spatial point to the writing versions."""
        return SpatialPointApplyList([node.as_apply() for node in self.data])


class SpatialPointApplyList(DomainModelApplyList[SpatialPointApply]):
    """List of spatial points in the writing version."""

    _INSTANCE = SpatialPointApply


def _create_spatial_point_filter(
    view_id: dm.ViewId,
