...
class Cdf3dModelQueryAPI(QueryAPI[T_DomainModelList]):
    def __init__(
        self,
        ...
        self._builder.append(
            QueryStep(
                ...
                select=dm.query.Select([dm.query.SourceSelector(self._view_by_write_class[Cdf3dModelApply], ["*"])]),
                result_cls=Cdf3dModel,
