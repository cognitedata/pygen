...
from movie_domain.client.data_classes import Rating, RatingApply, RatingList, RatingApplyList, RatingTextFields
from movie_domain.client.data_classes._rating import _RATING_TEXT_PROPERTIES_BY_FIELD
