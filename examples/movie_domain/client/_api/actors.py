...
from movie_domain.client.data_classes.actors import Actor, ActorApply, ActorList
...
class ActorsAPI(TypeAPI[Actor, ActorApply, ActorList]):
    ...
    def delete(self, external_id: str | Sequence[str]) -> dm.InstancesDeleteResult:
        if isinstance(external_id, str):
            ...
            return self._client.data_modeling.instances.delete(nodes=[(ActorApply.space, id) for id in external_id])
