...
class EquipmentModuleAPI(NodeAPI[EquipmentModule, EquipmentModuleWrite, EquipmentModuleList, EquipmentModuleWriteList]):
    ...
    def retrieve(self, external_id: str | SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> EquipmentModule | EquipmentModuleList | None:
    ...
    def search(
        ...
        filter: dm.Filter | None = None,
        sort_by: EquipmentModuleFields | SequenceNotStr[EquipmentModuleFields] | None = None,
