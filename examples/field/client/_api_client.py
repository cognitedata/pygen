...
from field.client import data_classes
from field.client._api import (
    AreaAPI,
    FieldAPI,
    RegionAPI,
)
from field.client._api._core import GraphQLQueryResponse, SequenceNotStr
from field.client.data_classes._core import GraphQLList
...
class FieldClient:
    ...
    def __init__(self, config_or_client: CogniteClient | ClientConfig):
        ...
        self.area = AreaAPI(client)
        self.field = FieldAPI(client)
        self.region = RegionAPI(client)
    ...
    @classmethod
    def from_toml(cls, file_path: Path | str, section: str | None = "cognite") -> FieldClient:
        import toml
    ...
    def _repr_html_(self) -> str:
        return """<strong>FieldClient(</strong> generated from data model
("fields-space", "Fields", "4")<br />
