...
from wind_turbine.data_classes._core.query.constants import DATA_RECORD_PROPERTIES
from wind_turbine.data_classes._core.query.step import QueryResultStep
