...
class _GeneratingUnitQuery(NodeQueryCore[T_DomainModelList, GeneratingUnitList]):  # type: ignore[type-var, valid-type]
    _view_id = GeneratingUnit._view_id
    _result_cls = GeneratingUnit  # type: ignore[assignment]
