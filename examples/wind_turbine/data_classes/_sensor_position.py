...
class _SensorPositionQuery(NodeQueryCore[T_DomainModelList, SensorPositionList]):  # type: ignore[type-var, valid-type]
    _view_id = SensorPosition._view_id
    _result_cls = SensorPosition  # type: ignore[assignment]
