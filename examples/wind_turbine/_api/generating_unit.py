...
class GeneratingUnitAPI(NodeAPI[GeneratingUnit, GeneratingUnitWrite, GeneratingUnitList, GeneratingUnitWriteList]):
    ...
    def __call__(
        ...
        Args:
            ...
            limit: Maximum number of generating units to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
    ...
    def apply(
        ...
        Args:
            generating_unit: Generating unit or sequence of generating units to upsert.
        ...
        Examples:
            ...
            Create a new generating_unit:
                ...
                >>> generating_unit = GeneratingUnitWrite(external_id="my_generating_unit", ...)
