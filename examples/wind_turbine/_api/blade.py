...
class BladeAPI(NodeAPI[Blade, BladeWrite, BladeList, BladeWriteList]):
    ...
    def iterate(
        ...
        Args:
            chunk_size: The number of blades to return in each iteration. Defaults to 100.
            is_damaged: The is damaged to filter on.
            name: The name to filter on.
            name_prefix: The prefix of the name to filter on.
            external_id_prefix: The prefix of the external ID to filter on.
            ...
            not retrieve any connections, 'identifier' will only retrieve the identifier of the connected items, and
            'full' will retrieve the full connected items.
            limit: Maximum number of blades to return. Defaults to None, which will return all items.
        ...
        Examples:
            ...
            Iterate blades in chunks of 100 up to 2000 items:
            ...
            Iterate blades in chunks of 100 sorted by external_id in descending order:
            ...
            Iterate blades in chunks of 100 and use cursors to resume the iteration:
