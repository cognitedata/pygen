...
class SolarPanelAPI(NodeAPI[SolarPanel, SolarPanelWrite, SolarPanelList, SolarPanelWriteList]):
    ...
    def __call__(
        ...
        Args:
            ...
            limit: Maximum number of solar panels to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
    ...
    def apply(
        ...
        Note: This method iterates through all nodes and timeseries linked to solar_panel and creates them including the edges
        between the nodes. For example, if any of `efficiency` or `orientation` are set, then these
        nodes as well as any nodes linked to them, and all the edges linking these nodes will be created.

        Args:
            solar_panel: Solar panel or sequence of solar panels to upsert.
        ...
        Examples:
            ...
            Create a new solar_panel:
                ...
                >>> solar_panel = SolarPanelWrite(external_id="my_solar_panel", ...)
    ...
    def list(
        ...
        Args:
            ...
            sort: (Advanced) If sort_by and direction are not sufficient, you can write your own sorting.
                This will override the sort_by and direction. This allowos you to sort by multiple fields and
                specify the direction for each field as well as how to handle null values.
            retrieve_connections: Whether to retrieve `efficiency` and `orientation` for the solar panels. Defaults to 'skip'.
