...
_GRAPHQL_DATA_CLASS_BY_DATA_MODEL_BY_TYPE: dict[dm.DataModelId, dict[str, type[GraphQLCore]]] = {
    dm.DataModelId("sp_pygen_power", "WindTurbine", "1"): {
        "Blade": data_classes.BladeGraphQL,
        "DataSheet": data_classes.DataSheetGraphQL,
        "Distance": data_classes.DistanceGraphQL,
        "Gearbox": data_classes.GearboxGraphQL,
        "GeneratingUnit": data_classes.GeneratingUnitGraphQL,
        ...
        "SensorTimeSeries": data_classes.SensorTimeSeriesGraphQL,
        "SolarPanel": data_classes.SolarPanelGraphQL,
