    ...
    def retrieve(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            'my_temperature' from 2 weeks ago up until now::
    ...
    def retrieve_arrays(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            we are using the time-ago format to get raw data for the 'my_temperature'
    ...
    def retrieve_dataframe_in_tz(
        ...
        **Performance guide**:
        ...
        Examples:
            ...
            In this example,
            get weekly aggregates for the 'my_temperature' for the
...
class MetmastTemperatureAPI:
    ...
    def __call__(
        ...
        Returns:
            ...
            the metmast.temperature timeseries
        ...
        Examples:
            ...
            Retrieve all data for 5 metmast.temperature timeseries:
                ...
                >>> from wind_turbine import WindTurbineClient
                >>> client = WindTurbineClient()
                >>> metmasts = client.metmast.temperature(
                ...     limit=5
                ... ).retrieve()
