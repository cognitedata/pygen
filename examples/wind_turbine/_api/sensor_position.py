...
class SensorPositionAPI(NodeAPI[SensorPosition, SensorPositionWrite, SensorPositionList, SensorPositionWriteList]):
    ...
    ) -> SensorPositionQueryAPI[SensorPosition, SensorPositionList]:
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new sensor_position:
                ...
                >>> sensor_position = SensorPositionWrite(
                ...     external_id="my_sensor_position", ...
                ... )
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [SensorPosition.model_validate(item) for item in unpacked]
        else:
            retrieved = [SensorPosition.model_construct(**item) for item in unpacked]
        return SensorPositionList(retrieved)
