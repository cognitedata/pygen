...
def _retrieve_timeseries_external_ids_with_extra_rpm_low_speed_shaft(
    ...
    if extra_properties == "rpm_low_speed_shaft":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "rpm_low_speed_shaft":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "rpm_low_speed_shaft"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["rpm_low_speed_shaft"]: [
