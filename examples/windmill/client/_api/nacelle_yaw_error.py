...
def _retrieve_timeseries_external_ids_with_extra_yaw_error(
    ...
    if extra_properties == "yaw_error":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "yaw_error":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "yaw_error"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["yaw_error"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
