...
from windmill.client.data_classes._gearbox import _create_gearbox_filter
...
def _retrieve_timeseries_external_ids_with_extra_displacement_z(
    ...
    if extra_properties == "displacement_z":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "displacement_z":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "displacement_z"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["displacement_z"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
