...
class BladeQueryAPI(QueryAPI[T_DomainModelList]):
    def __init__(
        ...
        self._builder.append(
            QueryStep(
                ...
                select=dm.query.Select([dm.query.SourceSelector(self._view_by_write_class[BladeApply], ["*"])]),
                result_cls=Blade,
    ...
    def sensor_positions(
        ...
        return SensorPositionQueryAPI(self._client, self._builder, self._view_by_write_class, None, limit)
