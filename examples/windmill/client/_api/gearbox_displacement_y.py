...
def _retrieve_timeseries_external_ids_with_extra_displacement_y(
    ...
    if extra_properties == "displacement_y":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "displacement_y":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "displacement_y"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["displacement_y"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
