...
from windmill.client.data_classes._power_inverter import (
...
class PowerInverterAPI(NodeAPI[PowerInverter, PowerInverterApply, PowerInverterList]):
    ...
    def __call__(
        ...
        return PowerInverterQueryAPI(self._client, builder, self._view_by_write_class, filter_, limit)
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new power_inverter:
                ...
                >>> from windmill.client.data_classes import PowerInverterApply
