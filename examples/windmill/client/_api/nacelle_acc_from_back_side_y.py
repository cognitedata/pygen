...
def _retrieve_timeseries_external_ids_with_extra_acc_from_back_side_y(
    ...
    if extra_properties == "acc_from_back_side_y":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "acc_from_back_side_y":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "acc_from_back_side_y"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["acc_from_back_side_y"]: [
