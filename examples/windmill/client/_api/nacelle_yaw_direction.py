...
from windmill.client.data_classes._nacelle import _create_nacelle_filter
...
def _retrieve_timeseries_external_ids_with_extra_yaw_direction(
    ...
    if extra_properties == "yaw_direction":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "yaw_direction":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "yaw_direction"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["yaw_direction"]: [node.properties[view_id].get(prop, "") for prop in extra_list]
