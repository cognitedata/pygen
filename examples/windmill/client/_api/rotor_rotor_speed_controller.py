...
from windmill.client.data_classes._rotor import _create_rotor_filter
...
def _retrieve_timeseries_external_ids_with_extra_rotor_speed_controller(
    ...
    if extra_properties == "rotor_speed_controller":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "rotor_speed_controller":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "rotor_speed_controller"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["rotor_speed_controller"]: [
