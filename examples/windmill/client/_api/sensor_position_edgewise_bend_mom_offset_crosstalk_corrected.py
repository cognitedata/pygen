...
from windmill.client.data_classes._sensor_position import _create_sensor_position_filter
...
def _retrieve_timeseries_external_ids_with_extra_edgewise_bend_mom_offset_crosstalk_corrected(
    ...
    if extra_properties == "edgewise_bend_mom_offset_crosstalk_corrected":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "edgewise_bend_mom_offset_crosstalk_corrected":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "edgewise_bend_mom_offset_crosstalk_corrected"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["edgewise_bend_mom_offset_crosstalk_corrected"]: [
