...
def _retrieve_timeseries_external_ids_with_extra_acc_from_back_side_z(
    ...
    if extra_properties == "acc_from_back_side_z":
        ...
    elif isinstance(extra_properties, str) and extra_properties != "acc_from_back_side_z":
        properties.append(extra_properties)
    elif isinstance(extra_properties, list):
        properties.extend([prop for prop in extra_properties if prop != "acc_from_back_side_z"])
    else:
    ...
    while True:
        ...
        batch_external_ids = {
            node.properties[view_id]["acc_from_back_side_z"]: [
