...
if isinstance(self.self_direct, DomainModel)
    ...
    def _update_connections(
        ...
        for instance in instances.values():
            if isinstance(instance.other_direct, dm.NodeId) and (other_direct := nodes_by_id.get(instance.other_direct)) and isinstance(
                    other_direct, ConnectionItemCNode
            ):
                instance.other_direct = other_direct
            if isinstance(instance.self_direct, dm.NodeId) and (self_direct := nodes_by_id.get(instance.self_direct)) and isinstance(
