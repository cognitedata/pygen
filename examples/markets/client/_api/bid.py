...
from markets.client.data_classes import Bid, BidApply, BidList, BidApplyList, BidTextFields
from markets.client.data_classes._bid import _BID_TEXT_PROPERTIES_BY_FIELD
