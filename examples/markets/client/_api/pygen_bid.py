...
from markets.client.data_classes import PygenBid, PygenBidApply, PygenBidList, PygenBidApplyList, PygenBidTextFields
from markets.client.data_classes._pygen_bid import _PYGENBID_TEXT_PROPERTIES_BY_FIELD
