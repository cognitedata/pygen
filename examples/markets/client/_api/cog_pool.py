...
from markets.client.data_classes import CogPool, CogPoolApply, CogPoolList, CogPoolApplyList, CogPoolTextFields
from markets.client.data_classes._cog_pool import _COGPOOL_TEXT_PROPERTIES_BY_FIELD
