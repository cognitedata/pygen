...
_GRAPHQL_DATA_CLASS_BY_DATA_MODEL_BY_TYPE: dict[dm.DataModelId, dict[str, type[GraphQLCore]]] = {
    dm.DataModelId("sp_pygen_models", "OmniMultiA", "1"): {
        "Implementation1": data_classes.Implementation1sSpPygenModelsGraphQL,
    ...
    dm.DataModelId("sp_pygen_models", "OmniMultiC", "1"): {
        "Implementation1": data_classes.Implementation1sSpPygenModelsOtherGraphQL,
    },
}
...
class PygenValidationError(ValueError):
    ...
    def __str__(self):
        return (
            ...
            f" importing `from omni_multi.config import global_config`."
        )
