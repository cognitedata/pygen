...
class Implementation1v2API(
    ...
    def __call__(
    ...
    ) -> Implementation1v2QueryAPI[Implementation1v2, Implementation1v2List]:
        ...
        return Implementation1v2QueryAPI(
    ...
    def apply(
        ...
        Args:
            implementation_1_v_2: Implementation 1 v 2 or
                sequence of implementation 1 v 2 to upsert.
        ...
        Examples:
            ...
            Create a new implementation_1_v_2:
                ...
                >>> implementation_1_v_2 = Implementation1v2Write(
                ...     external_id="my_implementation_1_v_2", ...
                ... )
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [Implementation1v2.model_validate(item) for item in unpacked]
        else:
            retrieved = [Implementation1v2.model_construct(**item) for item in unpacked]
        return Implementation1v2List(retrieved)
