...
class SubInterfaceAPI(NodeAPI[SubInterface, SubInterfaceWrite, SubInterfaceList, SubInterfaceWriteList]):
    ...
    @overload
    def retrieve(self, external_id: str, space: str, as_child_class: SequenceNotStr[Literal["Implementation1"]] | None = None) -> SubInterface | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str, as_child_class: SequenceNotStr[Literal["Implementation1"]] | None = None) -> SubInterfaceList:
        ...

    def retrieve(self, external_id: str | SequenceNotStr[str], space: str, as_child_class: SequenceNotStr[Literal["Implementation1"]] | None = None) -> SubInterface | SubInterfaceList | None:
