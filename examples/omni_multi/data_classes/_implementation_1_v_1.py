...
class Implementation1v1GraphQL(GraphQLCore):
    ...
    view_id: ClassVar[dm.ViewId] = dm.ViewId("sp_pygen_models-other", "Implementation1", "1")
...
class Implementation1v1(DomainModel):
    ...
    _view_id: ClassVar[dm.ViewId] = dm.ViewId("sp_pygen_models-other", "Implementation1", "1")
