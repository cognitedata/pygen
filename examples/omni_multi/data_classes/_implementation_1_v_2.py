...
class _Implementation1v2Query(NodeQueryCore[T_DomainModelList, Implementation1v2List]):  # type: ignore[type-var, valid-type]
    _view_id = Implementation1v2._view_id
    _result_cls = Implementation1v2  # type: ignore[assignment]
