...
class _CogniteAssetTypeQuery(NodeQueryCore[T_DomainModelList, CogniteAssetTypeList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteAssetType._view_id
    _result_cls = CogniteAssetType  # type: ignore[assignment]
