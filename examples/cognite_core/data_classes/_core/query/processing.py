...
from cognite_core.data_classes._core.query.constants import DATA_RECORD_PROPERTIES
from cognite_core.data_classes._core.query.step import QueryResultStep
