...
class _CogniteAssetClassQuery(NodeQueryCore[T_DomainModelList, CogniteAssetClassList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteAssetClass._view_id
    _result_cls = CogniteAssetClass  # type: ignore[assignment]
