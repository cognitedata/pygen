...
class _CogniteEquipmentQuery(NodeQueryCore[T_DomainModelList, CogniteEquipmentList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteEquipment._view_id
    _result_cls = CogniteEquipment  # type: ignore[assignment]
