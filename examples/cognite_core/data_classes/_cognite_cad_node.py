...
class _CogniteCADNodeQuery(NodeQueryCore[T_DomainModelList, CogniteCADNodeList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteCADNode._view_id
    _result_cls = CogniteCADNode  # type: ignore[assignment]
