...
class _CogniteDescribableNodeQuery(NodeQueryCore[T_DomainModelList, CogniteDescribableNodeList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteDescribableNode._view_id
    _result_cls = CogniteDescribableNode  # type: ignore[assignment]
