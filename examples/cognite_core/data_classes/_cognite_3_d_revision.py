...
class _Cognite3DRevisionQuery(NodeQueryCore[T_DomainModelList, Cognite3DRevisionList]):  # type: ignore[type-var, valid-type]
    _view_id = Cognite3DRevision._view_id
    _result_cls = Cognite3DRevision  # type: ignore[assignment]
