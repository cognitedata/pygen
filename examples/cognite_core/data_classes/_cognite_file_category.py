...
class _CogniteFileCategoryQuery(NodeQueryCore[T_DomainModelList, CogniteFileCategoryList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteFileCategory._view_id
    _result_cls = CogniteFileCategory  # type: ignore[assignment]
