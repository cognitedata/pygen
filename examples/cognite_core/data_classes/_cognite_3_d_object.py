...
class _Cognite3DObjectQuery(NodeQueryCore[T_DomainModelList, Cognite3DObjectList]):  # type: ignore[type-var, valid-type]
    _view_id = Cognite3DObject._view_id
    _result_cls = Cognite3DObject  # type: ignore[assignment]
