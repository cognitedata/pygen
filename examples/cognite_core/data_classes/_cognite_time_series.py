...
class _CogniteTimeSeriesQuery(NodeQueryCore[T_DomainModelList, CogniteTimeSeriesList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteTimeSeries._view_id
    _result_cls = CogniteTimeSeries  # type: ignore[assignment]
