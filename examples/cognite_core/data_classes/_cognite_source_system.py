...
class _CogniteSourceSystemQuery(NodeQueryCore[T_DomainModelList, CogniteSourceSystemList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteSourceSystem._view_id
    _result_cls = CogniteSourceSystem  # type: ignore[assignment]
