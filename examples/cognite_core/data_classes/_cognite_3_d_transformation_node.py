...
class _Cognite3DTransformationNodeQuery(NodeQueryCore[T_DomainModelList, Cognite3DTransformationNodeList]):  # type: ignore[type-var, valid-type]
    _view_id = Cognite3DTransformationNode._view_id
    _result_cls = Cognite3DTransformationNode  # type: ignore[assignment]
