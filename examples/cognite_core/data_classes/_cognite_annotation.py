...
__all__ = [
    "CogniteAnnotation",    "CogniteAnnotationWrite",    "CogniteAnnotationList",    "CogniteAnnotationWriteList",    "CogniteAnnotationFields",    "CogniteAnnotationTextFields",]


CogniteAnnotationTextFields = Literal["external_id", "aliases", "description", "name", "source_context", "source_created_user", "source_id", "source_updated_user", "tags"]
CogniteAnnotationFields = Literal["external_id", "aliases", "confidence", "description", "name", "source_context", "source_created_time", "source_created_user", "source_id", "source_updated_time", "source_updated_user", "status", "tags"]
_COGNITEANNOTATION_PROPERTIES_BY_FIELD = {    "external_id": "externalId",
    "aliases": "aliases",
...
class CogniteAnnotationWrite(CogniteDescribableEdgeWrite, CogniteSourceableEdgeWrite):
    ...
    Args:
        ...
        tags: Text based labels for generic use, limited to 1000
    """
    _container_fields: ClassVar[tuple[str, ...]] = ("aliases", "confidence", "description", "name", "source", "source_context", "source_created_time", "source_created_user", "source_id", "source_updated_time", "source_updated_user", "status", "tags",)
