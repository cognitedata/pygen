...
class _Cognite360ImageCollectionQuery(NodeQueryCore[T_DomainModelList, Cognite360ImageCollectionList]):  # type: ignore[type-var, valid-type]
    _view_id = Cognite360ImageCollection._view_id
    _result_cls = Cognite360ImageCollection  # type: ignore[assignment]
