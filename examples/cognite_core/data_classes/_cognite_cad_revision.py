...
class _CogniteCADRevisionQuery(NodeQueryCore[T_DomainModelList, CogniteCADRevisionList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteCADRevision._view_id
    _result_cls = CogniteCADRevision  # type: ignore[assignment]
