...
class _CognitePointCloudRevisionQuery(NodeQueryCore[T_DomainModelList, CognitePointCloudRevisionList]):  # type: ignore[type-var, valid-type]
    _view_id = CognitePointCloudRevision._view_id
    _result_cls = CognitePointCloudRevision  # type: ignore[assignment]
