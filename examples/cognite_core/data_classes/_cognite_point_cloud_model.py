...
CognitePointCloudModelFields = Literal["external_id", "aliases", "description", "name", "tags", "model_type"]
...
class CognitePointCloudModelGraphQL(GraphQLCore, protected_namespaces=()):
...
class CognitePointCloudModel(Cognite3DModel, protected_namespaces=()):
...
class CognitePointCloudModelWrite(Cognite3DModelWrite, protected_namespaces=()):
