...
class _CogniteCubeMapQuery(NodeQueryCore[T_DomainModelList, CogniteCubeMapList]):  # type: ignore[type-var, valid-type]
    _view_id = CogniteCubeMap._view_id
    _result_cls = CogniteCubeMap  # type: ignore[assignment]
