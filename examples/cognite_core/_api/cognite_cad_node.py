...
class CogniteCADNodeAPI(NodeAPI[CogniteCADNode, CogniteCADNodeWrite, CogniteCADNodeList, CogniteCADNodeWriteList]):
    ...
    ) -> CogniteCADNodeQueryAPI[CogniteCADNode, CogniteCADNodeList]:
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [CogniteCADNode.model_validate(item) for item in unpacked]
        else:
            retrieved = [CogniteCADNode.model_construct(**item) for item in unpacked]
        return CogniteCADNodeList(retrieved)
