...
class CognitePointCloudRevisionQueryAPI(QueryAPI[T_DomainModelList]):
    ...
    def __init__(
        ...
        self._builder.append(
            NodeQueryStep(
                ...
                result_cls=CognitePointCloudRevision,
    ...
    def query(
        ...
        Args:
            retrieve_model_3d: Whether to retrieve the model 3d for each Cognite point cloud revision or not.
