...
class CognitePointCloudRevisionQueryAPI(QueryAPI[T_DomainModel, T_DomainModelList]):
    ...
    def query(
        ...
        Args:
            retrieve_model_3d: Whether to retrieve the
                model 3d for each
                Cognite point cloud revision or not.
    ...
    def _query_append_model_3d(self, from_: str) -> None:
        self._builder.append(
            QueryStep(
                ...
                view_id=CognitePointCloudModel._view_id,
