...
class Cognite360ImageStationAPI(
    ...
    def __call__(
    ...
    ) -> Cognite360ImageStationQueryAPI[Cognite360ImageStationList]:
        ...
        builder = DataClassQueryBuilder(Cognite360ImageStationList)
        return Cognite360ImageStationQueryAPI(self._client, builder, filter_, limit)
