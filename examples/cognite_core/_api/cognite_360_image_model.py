...
class Cognite360ImageModelAPI(
    ...
    def apply(
        ...
        Note: This method iterates through all nodes and timeseries linked to cognite_360_image_model
    ...
    def list(
        ...
        Args:
            ...
            sort: (Advanced) If sort_by and direction are not sufficient, you can write your own sorting.
                ...
                specify the direction for each field as well as how to handle null values.
            retrieve_connections: Whether to retrieve `collections` and `thumbnail`
                for the Cognite 360 image models. Defaults to 'skip'.
