...
class CogniteCubeMapAPI(NodeAPI[CogniteCubeMap, CogniteCubeMapWrite, CogniteCubeMapList, CogniteCubeMapWriteList]):
    ...
    ) -> CogniteCubeMapQueryAPI[CogniteCubeMap, CogniteCubeMapList]:
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [CogniteCubeMap.model_validate(item) for item in unpacked]
        else:
            retrieved = [CogniteCubeMap.model_construct(**item) for item in unpacked]
        return CogniteCubeMapList(retrieved)
