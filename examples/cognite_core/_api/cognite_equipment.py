...
class CogniteEquipmentAPI(
    ...
    _properties_by_field = _COGNITEEQUIPMENT_PROPERTIES_BY_FIELD
    ...
    def __call__(
        ...
        Args:
            ...
            limit: Maximum number of Cognite equipments to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
    ...
    def apply(
        ...
        Note: This method iterates through all nodes and timeseries linked to cognite_equipment and creates them including the edges
        between the nodes. For example, if any of `asset`, `equipment_type`, `files` or `source` are set, then these
        nodes as well as any nodes linked to them, and all the edges linking these nodes will be created.

        Args:
            cognite_equipment: Cognite equipment or sequence of Cognite equipments to upsert.
        ...
        Examples:
            ...
            Create a new cognite_equipment:
                ...
                >>> cognite_equipment = CogniteEquipmentWrite(external_id="my_cognite_equipment", ...)
    ...
    def list(
        ...
        Args:
            ...
            sort: (Advanced) If sort_by and direction are not sufficient, you can write your own sorting.
                This will override the sort_by and direction. This allowos you to sort by multiple fields and
                specify the direction for each field as well as how to handle null values.
            retrieve_connections: Whether to retrieve `activities`, `asset`, `equipment_type`, `files`, `source` and `time_series` for the Cognite equipments. Defaults to 'skip'.
