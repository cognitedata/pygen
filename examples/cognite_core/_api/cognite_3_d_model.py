...
class Cognite3DModelAPI(NodeAPI[Cognite3DModel, Cognite3DModelWrite, Cognite3DModelList, Cognite3DModelWriteList]):
    ...
    ) -> Cognite3DModelQueryAPI[Cognite3DModel, Cognite3DModelList]:
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [Cognite3DModel.model_validate(item) for item in unpacked]
        else:
            retrieved = [Cognite3DModel.model_construct(**item) for item in unpacked]
        return Cognite3DModelList(retrieved)
