...
class CogniteCADRevisionQueryAPI(QueryAPI[T_DomainModelList]):
    ...
    def query(
        ...
        Args:
            retrieve_model_3d: Whether to retrieve the model 3d for each Cognite cad revision or not.
