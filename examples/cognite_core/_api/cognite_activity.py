...
class CogniteActivityAPI(NodeAPI[CogniteActivity, CogniteActivityWrite, CogniteActivityList, CogniteActivityWriteList]):
    ...
    def __call__(
    ...
    ) -> CogniteActivityQueryAPI[CogniteActivityList]:
        ...
        Args:
            ...
            limit: Maximum number of Cognite activities to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
        ...
        builder = DataClassQueryBuilder(CogniteActivityList)
        return CogniteActivityQueryAPI(self._client, builder, filter_, limit)
    ...
    def apply(
        ...
        Note: This method iterates through all nodes and timeseries linked to cognite_activity and creates them including the edges
        between the nodes. For example, if any of `assets`, `equipment`, `source` or `time_series` are set, then these
        nodes as well as any nodes linked to them, and all the edges linking these nodes will be created.

        Args:
            cognite_activity: Cognite activity or sequence of Cognite activities to upsert.
        ...
        Examples:
            ...
            Create a new cognite_activity:
                ...
                >>> cognite_activity = CogniteActivityWrite(external_id="my_cognite_activity", ...)
    ...
    def list(
        ...
        Args:
            ...
            sort: (Advanced) If sort_by and direction are not sufficient, you can write your own sorting.
                This will override the sort_by and direction. This allowos you to sort by multiple fields and
                specify the direction for each field as well as how to handle null values.
            retrieve_connections: Whether to retrieve `assets`, `equipment`, `source` and `time_series` for the Cognite activities. Defaults to 'skip'.
