...
class CognitePointCloudModelAPI(
    ...
    def __call__(
    ...
    ) -> CognitePointCloudModelQueryAPI[CognitePointCloudModel, CognitePointCloudModelList]:
        ...
        return CognitePointCloudModelQueryAPI(
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [CognitePointCloudModel.model_validate(item) for item in unpacked]
        else:
            retrieved = [CognitePointCloudModel.model_construct(**item) for item in unpacked]
        return CognitePointCloudModelList(retrieved)
