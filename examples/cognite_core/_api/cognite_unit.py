...
class CogniteUnitAPI(NodeAPI[CogniteUnit, CogniteUnitWrite, CogniteUnitList, CogniteUnitWriteList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new cognite_unit:
                ...
                >>> cognite_unit = CogniteUnitWrite(
                ...     external_id="my_cognite_unit", ...
                ... )
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [CogniteUnit.model_validate(item) for item in unpacked]
        else:
            retrieved = [CogniteUnit.model_construct(**item) for item in unpacked]
        return CogniteUnitList(retrieved)
