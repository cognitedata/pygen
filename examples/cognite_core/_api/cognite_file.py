...
class CogniteFileAPI(NodeAPI[CogniteFile, CogniteFileWrite, CogniteFileList, CogniteFileWriteList]):
    ...
    ) -> CogniteFileQueryAPI[CogniteFile, CogniteFileList]:
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [CogniteFile.model_validate(item) for item in unpacked]
        else:
            retrieved = [CogniteFile.model_construct(**item) for item in unpacked]
        return CogniteFileList(retrieved)
