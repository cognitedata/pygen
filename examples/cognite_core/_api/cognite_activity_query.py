...
class CogniteActivityQueryAPI(QueryAPI[T_DomainModelList]):
    ...
    def query(
        ...
        Args:
            retrieve_source: Whether to retrieve the source for each Cognite activity or not.
