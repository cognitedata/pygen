...
class CogniteSchedulableAPI(
    ...
    def apply(
        ...
        Args:
            cognite_schedulable: Cognite schedulable or
                sequence of Cognite schedulables to upsert.
        ...
        Examples:
            ...
            Create a new cognite_schedulable:
                ...
                >>> cognite_schedulable = CogniteSchedulableWrite(
                ...     external_id="my_cognite_schedulable", ...
                ... )
    ...
    def _query(
        ...
        return CogniteSchedulableList([CogniteSchedulable.model_validate(item) for item in unpacked])
