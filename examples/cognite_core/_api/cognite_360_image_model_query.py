...
class Cognite360ImageModelQueryAPI(QueryAPI[T_DomainModelList]):
    ...
    def query(
        ...
        Args:
            retrieve_thumbnail: Whether to retrieve the thumbnail for each Cognite 360 image model or not.
