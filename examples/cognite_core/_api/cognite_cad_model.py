...
class CogniteCADModelAPI(NodeAPI[CogniteCADModel, CogniteCADModelWrite, CogniteCADModelList, CogniteCADModelWriteList]):
    ...
    def __call__(
        ...
        Args:
            ...
            limit: Maximum number of Cognite cad models to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
    ...
    def apply(
        ...
        Note: This method iterates through all nodes and timeseries linked to cognite_cad_model and creates them including the edges
        between the nodes. For example, if any of `thumbnail` are set, then these
        nodes as well as any nodes linked to them, and all the edges linking these nodes will be created.

        Args:
            cognite_cad_model: Cognite cad model or sequence of Cognite cad models to upsert.
        ...
        Examples:
            ...
            Create a new cognite_cad_model:
                ...
                >>> cognite_cad_model = CogniteCADModelWrite(external_id="my_cognite_cad_model", ...)
    ...
    def list(
        ...
        Args:
            ...
            sort: (Advanced) If sort_by and direction are not sufficient, you can write your own sorting.
                This will override the sort_by and direction. This allowos you to sort by multiple fields and
                specify the direction for each field as well as how to handle null values.
            retrieve_connections: Whether to retrieve `revisions` and `thumbnail` for the Cognite cad models. Defaults to 'skip'.
