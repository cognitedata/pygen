...
class CogniteVisualizableAPI(
    ...
    def __call__(
        ...
        Args:
            ...
            limit: Maximum number of Cognite visualizables to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
        ...
        builder = DataClassQueryBuilder(CogniteVisualizableList)
        return CogniteVisualizableQueryAPI(self._client, builder, filter_, limit)
    ...
    def apply(
        ...
        Note: This method iterates through all nodes and timeseries linked to cognite_visualizable and creates them including the edges
        between the nodes. For example, if any of `object_3d` are set, then these
        nodes as well as any nodes linked to them, and all the edges linking these nodes will be created.

        Args:
            cognite_visualizable: Cognite visualizable or sequence of Cognite visualizables to upsert.
        ...
        Examples:
            ...
            Create a new cognite_visualizable:
                ...
                >>> cognite_visualizable = CogniteVisualizableWrite(external_id="my_cognite_visualizable", ...)
    ...
    def list(
        ...
        Args:
            ...
            limit: Maximum number of Cognite visualizables to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
            filter: (Advanced) If the filtering available in the above is not sufficient, you can write your own filtering which will be ANDed with the filter above.
            retrieve_connections: Whether to retrieve `object_3d` for the Cognite visualizables. Defaults to 'skip'.
