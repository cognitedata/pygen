...
class CogniteEquipmentTypeAPI(
    ...
    def __call__(
        ...
        return CogniteEquipmentTypeQueryAPI(
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [CogniteEquipmentType.model_validate(item) for item in unpacked]
        else:
            retrieved = [CogniteEquipmentType.model_construct(**item) for item in unpacked]
        return CogniteEquipmentTypeList(retrieved)
