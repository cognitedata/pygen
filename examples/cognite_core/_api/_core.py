    ...
    def _retrieve_and_set_edge_types(
        ...
        for edge_type, values in groupby(edge_api_name_type_direction_view_id_penta or [], lambda x: x[2].as_tuple()):
            ...
            if len(value_list) == 1:
                ...
                for no, (___, edge_name, ____, direction, view_id) in enumerate(value_list):
...
_GRAPHQL_DATA_CLASS_BY_DATA_MODEL_BY_TYPE: dict[dm.DataModelId, dict[str, type[GraphQLCore]]] = {
    dm.DataModelId("cdf_cdm", "CogniteCore", "v1"): {
        "Cognite360Image": data_classes.Cognite360ImageGraphQL,
        "Cognite360ImageAnnotation": data_classes.Cognite360ImageAnnotationGraphQL,
        "Cognite360ImageCollection": data_classes.Cognite360ImageCollectionGraphQL,
        "Cognite360ImageModel": data_classes.Cognite360ImageModelGraphQL,
        "Cognite360ImageStation": data_classes.Cognite360ImageStationGraphQL,
        "Cognite3DModel": data_classes.Cognite3DModelGraphQL,
        "Cognite3DObject": data_classes.Cognite3DObjectGraphQL,
        "Cognite3DRevision": data_classes.Cognite3DRevisionGraphQL,
        "Cognite3DTransformation": data_classes.Cognite3DTransformationNodeGraphQL,
        "CogniteActivity": data_classes.CogniteActivityGraphQL,
        "CogniteAnnotation": data_classes.CogniteAnnotationGraphQL,
        "CogniteAsset": data_classes.CogniteAssetGraphQL,
        "CogniteAssetClass": data_classes.CogniteAssetClassGraphQL,
        "CogniteAssetType": data_classes.CogniteAssetTypeGraphQL,
        "CogniteCADModel": data_classes.CogniteCADModelGraphQL,
        "CogniteCADNode": data_classes.CogniteCADNodeGraphQL,
        "CogniteCADRevision": data_classes.CogniteCADRevisionGraphQL,
        "CogniteCubeMap": data_classes.CogniteCubeMapGraphQL,
        "CogniteDescribable": data_classes.CogniteDescribableNodeGraphQL,
        "CogniteDiagramAnnotation": data_classes.CogniteDiagramAnnotationGraphQL,
        "CogniteEquipment": data_classes.CogniteEquipmentGraphQL,
        "CogniteEquipmentType": data_classes.CogniteEquipmentTypeGraphQL,
        "CogniteFile": data_classes.CogniteFileGraphQL,
        "CogniteFileCategory": data_classes.CogniteFileCategoryGraphQL,
        "CognitePointCloudModel": data_classes.CognitePointCloudModelGraphQL,
        "CognitePointCloudRevision": data_classes.CognitePointCloudRevisionGraphQL,
        "CognitePointCloudVolume": data_classes.CognitePointCloudVolumeGraphQL,
