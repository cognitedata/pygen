...
class Cognite3DObjectAPI(NodeAPI[Cognite3DObject, Cognite3DObjectWrite, Cognite3DObjectList, Cognite3DObjectWriteList]):
    ...
    def apply(
        ...
        Examples:
            ...
            Create a new cognite_3_d_object:
                ...
                >>> cognite_3_d_object = Cognite3DObjectWrite(
                ...     external_id="my_cognite_3_d_object", ...
                ... )
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [Cognite3DObject.model_validate(item) for item in unpacked]
        else:
            retrieved = [Cognite3DObject.model_construct(**item) for item in unpacked]
        return Cognite3DObjectList(retrieved)
