...
class Cognite3DRevisionAPI(
    ...
    def __call__(
    ...
    ) -> Cognite3DRevisionQueryAPI[Cognite3DRevision, Cognite3DRevisionList]:
        ...
        return Cognite3DRevisionQueryAPI(
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [Cognite3DRevision.model_validate(item) for item in unpacked]
        else:
            retrieved = [Cognite3DRevision.model_construct(**item) for item in unpacked]
        return Cognite3DRevisionList(retrieved)
