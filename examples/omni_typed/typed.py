...
class Implementation1Apply(Implementation1Properties, TypedNodeApply):
    def __init__(
        self,
        space: str,
        external_id: str,
...
class Implementation2Apply(Implementation2Properties, TypedNodeApply):
    def __init__(
        self,
        space: str,
        external_id: str,
...
class Implementation2(Implementation2Properties, TypedNode):
    def __init__(
        self,
        space: str,
        external_id: str,
