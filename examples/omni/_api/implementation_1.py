...
class Implementation1API(NodeAPI[Implementation1, Implementation1Write, Implementation1List, Implementation1WriteList]):
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [Implementation1.model_validate(item) for item in unpacked]
        else:
            retrieved = [Implementation1.model_construct(**item) for item in unpacked]
        return Implementation1List(retrieved)
