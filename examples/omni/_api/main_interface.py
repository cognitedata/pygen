...
class MainInterfaceAPI(NodeAPI[MainInterface, MainInterfaceWrite, MainInterfaceList, MainInterfaceWriteList]):
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE, as_child_class: SequenceNotStr[Literal["Implementation1", "SubInterface"]] | None = None) -> MainInterface | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE, as_child_class: SequenceNotStr[Literal["Implementation1", "SubInterface"]] | None = None) -> MainInterfaceList:
        ...

    def retrieve(self, external_id: str | SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE, as_child_class: SequenceNotStr[Literal["Implementation1", "SubInterface"]] | None = None) -> MainInterface | MainInterfaceList | None:
