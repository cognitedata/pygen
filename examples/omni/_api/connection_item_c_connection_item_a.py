...
class ConnectionItemCConnectionItemAAPI(EdgeAPI):
    def list(
        self,
        ...
        Examples:
            ...
            List 5 connection item a edges connected to "my_connection_item_c":

                >>> from omni import OmniClient
                >>> client = OmniClient()
                >>> connection_item_c = client.connection_item_c.connection_item_a_edge.list("my_connection_item_c", limit=5)
