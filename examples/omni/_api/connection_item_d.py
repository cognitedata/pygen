...
class ConnectionItemDAPI(NodeAPI[ConnectionItemD, ConnectionItemDWrite, ConnectionItemDList, ConnectionItemDWriteList]):
    ...
    def __call__(
        ...
        builder = DataClassQueryBuilder(ConnectionItemDList)
    ...
    def list(
        ...
        Args:
            ...
            sort: (Advanced) If sort_by and direction are not sufficient, you can write your own sorting.
                ...
                specify the direction for each field as well as how to handle null values.
            retrieve_connections: Whether to retrieve `direct_multi`, `direct_single` and `outwards_single`
                for the connection item ds. Defaults to 'skip'.
