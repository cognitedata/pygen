...
class ConnectionItemAAPI(NodeAPI[ConnectionItemA, ConnectionItemAWrite, ConnectionItemAList, ConnectionItemAWriteList]):
    ...
    ) -> ConnectionItemAQueryAPI[ConnectionItemA, ConnectionItemAList]:
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [ConnectionItemA.model_validate(item) for item in unpacked]
        else:
            retrieved = [ConnectionItemA.model_construct(**item) for item in unpacked]
        return ConnectionItemAList(retrieved)
