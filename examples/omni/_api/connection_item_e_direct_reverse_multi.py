...
class ConnectionItemEDirectReverseMultiAPI(EdgeAPI):
    def list(
        self,
        ...
        """List direct reverse multi edges of a connection item e.
        ...
        Args:
            ...
            limit: Maximum number of direct reverse multi edges to return. Defaults to 25. Set to -1, float("inf") or None
                to return all items.

        Returns:
            The requested direct reverse multi edges.

        Examples:

            List 5 direct reverse multi edges connected to "my_connection_item_e":

                >>> from omni import OmniClient
                >>> client = OmniClient()
                >>> connection_item_e = client.connection_item_e.direct_reverse_multi_edge.list("my_connection_item_e", limit=5)
