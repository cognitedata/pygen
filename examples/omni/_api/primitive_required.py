...
class PrimitiveRequiredAPI(
    ...
    def apply(
        ...
        Args:
            primitive_required: Primitive required or
                sequence of primitive requireds to upsert.
        ...
        Examples:
            ...
            Create a new primitive_required:
                ...
                >>> client = OmniClient()
                >>> primitive_required = PrimitiveRequiredWrite(
                ...     external_id="my_primitive_required", ...
                ... )
    ...
    def _query(
        ...
        if global_config.validate_retrieve:
            retrieved = [PrimitiveRequired.model_validate(item) for item in unpacked]
        else:
            retrieved = [PrimitiveRequired.model_construct(**item) for item in unpacked]
        return PrimitiveRequiredList(retrieved)
