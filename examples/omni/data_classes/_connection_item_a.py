...
class _ConnectionItemAQuery(NodeQueryCore[T_DomainModelList, ConnectionItemAList]):  # type: ignore[type-var, valid-type]
    _view_id = ConnectionItemA._view_id
    _result_cls = ConnectionItemA  # type: ignore[assignment]
