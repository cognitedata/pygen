...
class _ConnectionItemDQuery(NodeQueryCore[T_DomainModelList, ConnectionItemDList]):  # type: ignore[type-var, valid-type]
    _view_id = ConnectionItemD._view_id
    _result_cls = ConnectionItemD  # type: ignore[assignment]
