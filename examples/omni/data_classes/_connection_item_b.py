...
class _ConnectionItemBQuery(NodeQueryCore[T_DomainModelList, ConnectionItemBList]):  # type: ignore[type-var, valid-type]
    _view_id = ConnectionItemB._view_id
    _result_cls = ConnectionItemB  # type: ignore[assignment]
