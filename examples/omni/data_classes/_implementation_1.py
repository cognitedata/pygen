...
class _Implementation1Query(NodeQueryCore[T_DomainModelList, Implementation1List]):  # type: ignore[type-var, valid-type]
    _view_id = Implementation1._view_id
    _result_cls = Implementation1  # type: ignore[assignment]
