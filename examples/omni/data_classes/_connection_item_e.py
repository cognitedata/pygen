...
class _ConnectionItemEQuery(NodeQueryCore[T_DomainModelList, ConnectionItemEList]):  # type: ignore[type-var, valid-type]
    _view_id = ConnectionItemE._view_id
    _result_cls = ConnectionItemE  # type: ignore[assignment]
