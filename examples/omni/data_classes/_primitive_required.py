...
class _PrimitiveRequiredQuery(NodeQueryCore[T_DomainModelList, PrimitiveRequiredList]):  # type: ignore[type-var, valid-type]
    _view_id = PrimitiveRequired._view_id
    _result_cls = PrimitiveRequired  # type: ignore[assignment]
