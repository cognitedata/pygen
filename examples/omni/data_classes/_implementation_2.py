...
class _Implementation2Query(NodeQueryCore[T_DomainModelList, Implementation2List]):  # type: ignore[type-var, valid-type]
    _view_id = Implementation2._view_id
    _result_cls = Implementation2  # type: ignore[assignment]
