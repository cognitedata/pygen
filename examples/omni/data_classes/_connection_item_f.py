...
class _ConnectionItemFQuery(NodeQueryCore[T_DomainModelList, ConnectionItemFList]):  # type: ignore[type-var, valid-type]
    _view_id = ConnectionItemF._view_id
    _result_cls = ConnectionItemF  # type: ignore[assignment]
