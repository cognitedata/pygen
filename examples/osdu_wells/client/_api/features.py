...
class FeaturesAPI(NodeAPI[Features, FeaturesApply, FeaturesList]):
    ...
    def apply(self, feature: FeaturesApply | Sequence[FeaturesApply], replace: bool = False) -> ResourcesApplyResult:
        ...
        Examples:
            ...
            Create a new feature:
                ...
                >>> from osdu_wells.client.data_classes import FeaturesApply
                >>> client = OSDUClient()
    ...
    @overload
    def retrieve(self, external_id: str, space: str = DEFAULT_INSTANCE_SPACE) -> Features | None:
        ...

    @overload
    def retrieve(self, external_id: SequenceNotStr[str], space: str = DEFAULT_INSTANCE_SPACE) -> FeaturesList:
        ...
