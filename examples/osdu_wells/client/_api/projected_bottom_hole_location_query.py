...
class ProjectedBottomHoleLocationQueryAPI(QueryAPI[T_DomainModelList]):
        ...
        self._builder.append(
            QueryStep(
                ...
                select=dm.query.Select(
                    [dm.query.SourceSelector(self._view_by_write_class[ProjectedBottomHoleLocationApply], ["*"])]
                ),
    ...
    def query(
        ...
        Args:
            retrieve_as_ingested_coordinates: Whether to retrieve the as ingested coordinate for each projected bottom hole location or not.
            retrieve_wgs_84_coordinates: Whether to retrieve the wgs 84 coordinate for each projected bottom hole location or not.
        ...
        self._builder.append(
            QueryStep(
                ...
                expression=dm.query.NodeResultSetExpression(
                    ...
                    from_=from_,
                    through=self._view_by_write_class[ProjectedBottomHoleLocationApply].as_property_ref("person"),
                    direction="outwards",
                ),
