...
class WellDataFacilityStatesAPI(EdgeAPI):
    def list(
        ...
        to_facility_state: str | list[str] | dm.NodeId | list[dm.NodeId] | None = None,
        to_facility_state_space: str = DEFAULT_INSTANCE_SPACE,
        ...
        Args:
            ...
            to_facility_state: ID of the target facility state.
            to_facility_state_space: Location of the facility states.
