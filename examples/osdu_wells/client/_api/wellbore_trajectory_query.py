        ...
        self._builder.append(
            QueryStep(
                ...
                select=dm.query.Select(
                    [dm.query.SourceSelector(self._view_by_write_class[WellboreTrajectoryApply], ["*"])]
                ),
    ...
    def meta(
        ...
        Args:
            ...
            limit: Maximum number of meta edges to return. Defaults to 25. Set to -1, float("inf") or None
                to return all items.
            retrieve_acl: Whether to retrieve the acl for each wellbore trajectory or not.
            retrieve_ancestry: Whether to retrieve the ancestry for each wellbore trajectory or not.
            retrieve_data: Whether to retrieve the datum for each wellbore trajectory or not.
            retrieve_legal: Whether to retrieve the legal for each wellbore trajectory or not.
            retrieve_tags: Whether to retrieve the tag for each wellbore trajectory or not.
