...
if TYPE_CHECKING:
    ...
    from ._wellbore_data import WellboreData, WellboreDataApply


__all__ = ["Wellbore", "WellboreApply", "WellboreList", "WellboreApplyList", "WellboreFields", "WellboreTextFields"]


WellboreTextFields = Literal["create_time", "create_user", "id_", "kind", "modify_time", "modify_user"]
WellboreFields = Literal["create_time", "create_user", "id_", "kind", "modify_time", "modify_user", "version_"]
...
class Wellbore(DomainModel):
    """This represents the reading version of wellbore.
    ...
    data: Union[WellboreData, str, dm.NodeId, None] = Field(None, repr=False)
    ...
    def as_apply(self) -> WellboreApply:
        """Convert this read version of wellbore to the writing version."""
...
class WellboreApply(DomainModelApply):
    """This represents the writing version of wellbore.
    ...
    Args:
        ...
        tags: The tag field.
        version_: The version field.
        existing_version: Fail the ingestion request if the wellbore version is greater than or equal to this value.
    ...
    create_time: Optional[str] = Field(None, alias="createTime")
    create_user: Optional[str] = Field(None, alias="createUser")
    data: Union[WellboreDataApply, str, dm.NodeId, None] = Field(None, repr=False)
    id_: Optional[str] = Field(None, alias="id")
    kind: Optional[str] = None
    ...
    def _to_instances_apply(
        ...
        write_view = (view_by_write_class and view_by_write_class.get(type(self))) or dm.ViewId(
            "IntegrationTestsImmutable", "Wellbore", "7a44cf38aa4fe7"
        )
        ...
        if properties:
            this_node = dm.NodeApply(
                ...
                type=dm.DirectRelationReference("IntegrationTestsImmutable", "Wellbore"),
                sources=[
                    dm.NodeOrEdgeData(
                        source=write_view,
        ...
        edge_type = dm.DirectRelationReference("IntegrationTestsImmutable", "Wellbore.meta")
...
class WellboreList(DomainModelList[Wellbore]):
    """List of wellbores in the read version."""

    _INSTANCE = Wellbore

    def as_apply(self) -> WellboreApplyList:
        """Convert these read versions of wellbore to the writing versions."""
        return WellboreApplyList([node.as_apply() for node in self.data])


class WellboreApplyList(DomainModelApplyList[WellboreApply]):
    """List of wellbores in the writing version."""

    _INSTANCE = WellboreApply


def _create_wellbore_filter(
    view_id: dm.ViewId,
