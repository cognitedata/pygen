...
class SpatialPoint(DomainModel):
    """This represent a read version of spatial point.
    ...
    def as_apply(self) -> SpatialPointApply:
        """Convert this read version of spatial point to a write version."""
...
class SpatialPointApply(DomainModelApply):
    """This represent a write version of spatial point.
    ...
    def _to_instances_apply(
        ...
        if properties:
            source = dm.NodeOrEdgeData(
                source=write_view or dm.ViewId("IntegrationTestsImmutable", "SpatialPoint", "7af8800660eef4"),
...
class SpatialPointList(TypeList[SpatialPoint]):
    """List of spatial points in read version."""
...
class SpatialPointApplyList(TypeApplyList[SpatialPointApply]):
    """List of spatial points in write version."""

    _NODE = SpatialPointApply
