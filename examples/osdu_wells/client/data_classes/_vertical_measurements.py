...
class VerticalMeasurementsList(DomainModelList[VerticalMeasurements]):
    """List of vertical measurements in the read version."""

    _INSTANCE = VerticalMeasurements
...
class VerticalMeasurementsApplyList(DomainModelApplyList[VerticalMeasurementsApply]):
    """List of vertical measurements in the writing version."""

    _INSTANCE = VerticalMeasurementsApply
