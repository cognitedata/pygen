/**
 * API class for RelatesTo instances.
 *
...
export class RelatesToApi extends InstanceAPI<RelatesTo> {
  ...
  private _buildFilter(options: {
    ...
    filter.relationType.prefix(options.relationTypePrefix ?? null);
    filter.strength.greaterThanOrEquals(options.minStrength ?? null);
    filter.strength.lessThanOrEquals(options.maxStrength ?? null);
    filter.createdAt.greaterThanOrEquals(options.minCreatedAt ?? null);
    filter.createdAt.lessThanOrEquals(options.maxCreatedAt ?? null);
   ...
   * @returns A RelatesToList of matching instances.
   */
