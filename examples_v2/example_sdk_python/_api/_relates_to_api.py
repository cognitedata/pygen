...
class RelatesToApi(InstanceAPI[RelatesTo, RelatesToList]):
    """API for RelatesTo instances with type-safe filter methods."""
    ...
    def retrieve(
        ...
        """Retrieve RelatesTo instances by ID.
    ...
    def aggregate(
        ...
        relation_type_prefix: str | None = None,
        ...
        Args:
            ...
            relation_type: Filter by exact relation type or list of values.
            relation_type_prefix: Filter by relation type prefix.
            min_strength: Minimum strength (inclusive).
            max_strength: Maximum strength (inclusive).
            min_created_at: Minimum created at (inclusive).
            max_created_at: Maximum created at (inclusive).
        ...
        filter_.relation_type.prefix(relation_type_prefix)
        filter_.strength.greater_than_or_equals(min_strength)
        filter_.strength.less_than_or_equals(max_strength)
        filter_.created_at.greater_than_or_equals(min_created_at)
        filter_.created_at.less_than_or_equals(max_created_at)
    ...
    def search(
        ...
        Returns:
            A RelatesToList with matching instances.
        """
        filter_ = RelatesToFilter("and")
        filter_.relation_type.equals_or_in(relation_type)
        filter_.relation_type.prefix(relation_type_prefix)
    ...
    def list(
        ...
        Returns:
            A RelatesToList of matching instances.
        """
        filter_ = RelatesToFilter("and")
        filter_.relation_type.equals_or_in(relation_type)
        filter_.relation_type.prefix(relation_type_prefix)
