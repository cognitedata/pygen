...
from cognite.client import CogniteClient  # noqa: E402
from cognite.client import data_modeling as dm  # noqa: E402
from cognite.client.data_classes import ExtractionPipelineRunWrite, RowWrite  # noqa: E402
from cognite.client.data_classes.data_modeling.cdm.v1 import (  # noqa: E402
...
def handle(data: dict, client: CogniteClient) -> dict:
    try:
        ...
        if last_entry_this_file:
            suffix = (f" in function {last_entry_this_file.name} "
                      f"on line {last_entry_this_file.lineno}: {last_entry_this_file.line}")
