...
from cognite.pygen._legacy._core.models import EdgeDataClass, NodeDataClass
...
from tests.test_python.test_legacy.omni_constants import OMNI_SPACE
from tests.test_python.test_legacy.utils import to_data_class_by_view_id
