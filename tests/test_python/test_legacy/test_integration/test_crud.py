...
from cognite.pygen._legacy.utils.mock_generator import MockGenerator, _connected_views
from tests.test_python.test_legacy.constants import OMNI_SDK
from tests.test_python.test_legacy.omni_constants import OmniClasses
